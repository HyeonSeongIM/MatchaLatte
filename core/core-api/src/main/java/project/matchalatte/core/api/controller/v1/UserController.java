...
public class UserController {
    ...
    public ApiResponse<UserReadResponse> getUser(@PathVariable("id") Long id) {
        ...
        log.info("{}", LogData.of("유저정보 가져오기", "처리시작"));
        User result;
        try {
        ...
        log.info("{}", LogData.of("유저정보 가져오기", "처리완료"));
